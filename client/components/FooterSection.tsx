        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:pr-8 md:border-r md:border-white/10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-lg font-semibold font-poppins">Alice.M</p>
            </div>
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-semibold text-lg mb-4 font-poppins">Navigation</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="font-semibold text-lg mb-4 font-poppins">All Services</h4>
            <ul className="space-y-3 text-white/70 text-sm font-poppins">
              {[
                "Web Design",
                "Web Development",
